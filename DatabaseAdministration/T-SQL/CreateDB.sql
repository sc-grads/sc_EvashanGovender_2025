CREATE DATABASE [70-461]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'70-461', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER2\MSSQL\DATA\70-461.mdf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'70-461_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER2\MSSQL\DATA\70-461_log.ldf' , SIZE = 8192KB , FILEGROWTH = 65536KB )
 WITH LEDGER = OFF
GO
ALTER DATABASE [70-461] SET COMPATIBILITY_LEVEL = 160
GO
...
GO
ALTER DATABASE [70-461] SET AUTO_CREATE_STATISTICS ON(INCREMENTAL = OFF)
GO
...
USE [70-461]
GO
IF NOT EXISTS (SELECT name FROM sys.filegroups WHERE is_default=1 AND name = N'PRIMARY') ALTER DATABASE [70-461] MODIFY FILEGROUP [PRIMARY] DEFAULT
GO
